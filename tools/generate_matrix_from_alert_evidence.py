...
# --- Stałe layoutu jak w defender_lab.py ---
TACTICS_ORDER = [
...
def main():
    ...
    for value, rows in by_group.items():
        ...
        # Tylko kolumny z danymi (nie puste!)
        nonempty_fields = set()
...
"""
        ...
        # Inputy pod nagłówkami (do każdego pola)
        inputs_row = "".join(
